...
class BaseBlock(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, feature_width, t = 6, downsample = False):
        """
        ...
        #attention
        self.coordatt = Coord_Index_Att(c,c,feature_width)
    ...
    def forward(self, inputs):
        ...
        x = F.relu6(self.bn2(self.coordatt(self.conv2(x))), inplace = True)
