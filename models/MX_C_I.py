...
import torch
import math
from models.coord_index_att import Coord_Index_Att
...
class I2RBlock(nn.Module):
    def __init__(self, inp, oup, f, stride, expand_ratio, keep_3x3=False):
        ...
        if expand_ratio == 2:
            self.conv = nn.Sequential(
                ...
                Coord_Index_Att(inp,inp,self.feature_size),
                nn.BatchNorm2d(inp),
                nn.ReLU6(inplace=True),
                # pw-linear
    ...
    def __init__(self, num_classes=1000, width_mult=1.):
        ...
        for t, c, n, s, f in self.cfgs:
            ...
            if c == 1280 and width_mult < 1:
                output_channel = 1280
            layers.append(block(input_channel, output_channel,f, s, t, n==1 and s==1))
            input_channel = output_channel
            for i in range(n-1):
                layers.append(block(input_channel, output_channel, f, 1, t))
                input_channel = output_channel
